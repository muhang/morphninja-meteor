...
RedditComment = new Mongo.Collection("redditcomment");
...
Router.route('/reddit/comments/:postID', {
    waitOn: function () {
        Meteor.subscribe("redditcomments");
    },
    data: function () {
        return RedditComment.find({ storyID: this.params.postID }); 
    },
    template: 'redditcomments'
});
